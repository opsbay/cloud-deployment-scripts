...
# Thanks to widdix for this script
# https://github.com/widdix/aws-ec2-ssh/blob/v1.2.0/import_users.sh
...
function sync_accounts() {
    ...
    # Changes due Nesssus audit - Ensure permissions on /etc/passwd- are configured
