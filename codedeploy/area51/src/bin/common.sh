...
export AREA51_SUPPORT_LOG="/var/log/area51_support.log"
export AREA51_ACCESS_LOG="/var/log/area51_access.log"
export AREA51_JOBS_LOG="/var/log/area51_jobs.log"
export AREA51_REQUEST_LOG="/var/log/area51_request.log"

export LOCK_DIR="/var/lock/naviance"
...
export CACHE_DIR="/tmp/area51-cache"
export BACKUP_DIR="/httpd/area51/backup"
...
get_server_name_json() {
    ...
    case "$DEPLOYMENT_GROUP_NAME" in
        ...
        production)
            server_name="tf-$APP_NAME-$PHP_VERSION-$DEPLOYMENT_GROUP_NAME.papaya.naviance.com"
            # Final value is area51-internal.naviance.com
        ;;
