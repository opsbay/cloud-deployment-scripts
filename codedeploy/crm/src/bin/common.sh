...
export APP_DIR="/httpd/crm"
export DOCUMENT_ROOT="$APP_DIR"
...
get_server_name_json() {
    ...
    case "$DEPLOYMENT_GROUP_NAME" in
        staging|qa)
            server_name="tf-crm-$PHP_VERSION-$DEPLOYMENT_GROUP_NAME.mango.naviance.com"
            succeed_server_name="tf-crm-$PHP_VERSION-$DEPLOYMENT_GROUP_NAME.mango.naviance.com"
        ;;

        preprod)
            server_name="tf-crm-$PHP_VERSION-$DEPLOYMENT_GROUP_NAME.papaya.naviance.com"
            succeed_server_name="tf-crm-$PHP_VERSION-$DEPLOYMENT_GROUP_NAME.papaya.naviance.com"
        ;;

        production)
            server_name="crm.naviance.com"
