module "succeed-legacy-cron-many-56" {
  source = "./modules/webapp"

  name            = "cron-legacy-many-56"
  codedeploy_path = "cron-legacy"
  ...
  additional_role_policies = [
    "${data.template_file.district_imports_queue_policy_template.*.rendered}",
  ]
