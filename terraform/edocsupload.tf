module "edocsupload" {
  ...
  lb_security_groups = [
    "${module.vpc.default_security_group_id}",
    "${aws_security_group.edocsupload-service.id}",
  ...
  instance_types                = ["${var.edocsupload_instance_types}"]
...
resource "aws_security_group" "edocsupload-service" {
  name        = "tf-edocsupload-service-sg"
