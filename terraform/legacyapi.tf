module "legacyapi" {
  ...
  name                = "legacyapi"
  codedeploy_path     = "legacyapi"
  health_check_port   = 8742
  ...
  lb_security_groups = [
    ...
    "${aws_security_group.legacyapi-service.id}",
...
resource "aws_security_group" "legacyapi-service" {
  name        = "tf-legacyapi-service-sg"
