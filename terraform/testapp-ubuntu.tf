module "testapp-ubuntu" {
  source = "./modules/webapp"

  name                = "testapp-ubuntu"
  codedeploy_path     = "placeholder"
  health_check_target = "/"                     # TODO: get real health check
  health_check_type   = "EC2"
  amis                = "${var.testapp-ubuntu}"
  ...
  subnet_count = "${length(module.vpc.private_app_subnets)}"
