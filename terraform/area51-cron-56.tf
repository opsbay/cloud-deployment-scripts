module "area51-cron-56" {
  source = "./modules/webapp"

  name            = "area51-cron-56"
  codedeploy_path = "area51-cron"
  ...
  instance_types                = ["${var.area51_cron_instance_types}"]
  autoscaling_capacity_defaults = ["${var.area51_cron_autoscaling_capacity_defaults}"]
